...
class MytsMycode extends MyTextSanitizerExtension
{
    ...
    function encode($textarea_id)
    {
        ...
        $code = "<img src='{$this->image_path}/mycode.gif' alt='" . _WORTIFY_FORM_ALTMYCODE . "' onclick='wortifyCodeMycode(\"{$textarea_id}\",\"" . htmlspecialchars(_WORTIFY_FORM_ENTERMYCODETERM, ENT_QUOTES) . "\");'  onmouseover='style.cursor=\"hand\"'/>&nbsp;";
        $javascript = <<<EOH
            function wortifyCodeMycode(id, enterMycodePhrase){
