...
class WortifytsMms extends WortifyTextSanitizerExtension
{
    function encode($textarea_id)
    {
        $config = parent::loadConfig(dirname(__FILE__));
        $code = "<img src='{$this->image_path}/mmssrc.gif' alt='" . _WORTIFY_FORM_ALTMMS . "' onclick='wortifyCodeMms(\"{$textarea_id}\",\"" . htmlspecialchars(_WORTIFY_FORM_ENTERMMSURL, ENT_QUOTES) . "\",\"" . htmlspecialchars(_WORTIFY_FORM_ENTERHEIGHT, ENT_QUOTES) . "\",\"" . htmlspecialchars(_WORTIFY_FORM_ENTERWIDTH, ENT_QUOTES) . "\");'  onmouseover='style.cursor=\"hand\"'/>&nbsp;";
        $javascript = <<<EOH
            function wortifyCodeMms(id,enterMmsPhrase, enterMmsHeightPhrase, enterMmsWidthPhrase)
            {
