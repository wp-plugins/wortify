...
class WortifyAuthRest_JsonProvisionning {
	...
	function &getInstance(&$auth_instance)
	{
		...
		if (!isset($provis_instance)) {
			$provis_instance = new WortifyAuthRest_JsonProvisionning($auth_instance);
		}
	 ...
	 */
	function WortifyAuthRest_JsonProvisionning (&$auth_instance) {
