...
class WortifyAuthMinimumCloudProvisionning {
	...
	function &getInstance(&$auth_instance)
	{
		...
		if (!isset($provis_instance)) {
			$provis_instance = new WortifyAuthMinimumCloudProvisionning($auth_instance);
		}
	 ...
	 */
	function WortifyAuthMinimumCloudProvisionning (&$auth_instance) {
