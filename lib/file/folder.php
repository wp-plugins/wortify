...
class WortifyFolderHandler
{
    ...
    function WortifyFolderHandler($path, $create = false, $mode = false)
    {
    ...
    {
        if (WortifyFolderHandler::isWindowsPath($path)) {
            return '\\';
        }
        return '/';
    }
    ...
    {
        if (WortifyFolderHandler::isSlashTerm($path)) {
            return $path;
        }
        return $path . WortifyFolderHandler::correctSlashFor($path);
    }
    ...
    /**
     * Returns true if the File is in a given WortifyPath.
     *
     * @return bool
     * @access public
     */
