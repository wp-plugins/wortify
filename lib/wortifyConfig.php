...
class wortifyConfig {
		...
		array( 
			"protector" => array(
				"wortify_global_disabled" => array(
											...
											'title'			=> '_WORTIFY_GLOBAL_DISBL' ,
											'description'	=> '_WORTIFY_GLOBAL_DISBLDSC' ,
											'formtype'		=> 'yesno' ,
											'valuetype'		=> 'int' ,
											'default'		=> "0" ,
											'options'		=> array()
				...
				"wortify_log_level" => array(
										...
										'title'			=> '_WORTIFY_LOG_LEVEL' ,
										'description'	=> '' ,
										'formtype'		=> 'select' ,
										'valuetype'		=> 'int' ,
										'default'		=>  255 ,
										'options'		=> array( '_WORTIFY_LOGLEVEL0' => 0 , '_WORTIFY_LOGLEVEL15' => 15 , '_WORTIFY_LOGLEVEL63' => 63 , '_WORTIFY_LOGLEVEL255' => 255 )
									),
				"wortify_banip_time0" => array(
										'name'			=> 'wortify_banip_time0' ,
										'title'			=> '_WORTIFY_BANIP_TIME0' ,
										'description'	=> '' ,
										'formtype'		=> 'text' ,
										'valuetype'		=> 'int' ,
										'default'		=> 86400 ,
				...
				"wortify_reliable_ips" => array(
										...
										'title'			=> '_WORTIFY_RELIABLE_IPS' ,
										'description'	=> '_WORTIFY_RELIABLE_IPSDSC' ,
										'formtype'		=> 'textarea' ,
										'valuetype'		=> 'array' ,
				...
				"wortify_session_fixed_topbit" => array(
											...
											'title'			=> '_WORTIFY_HIJACK_TOPBIT' ,
											'description'	=> '_WORTIFY_HIJACK_TOPBITDSC' ,
											'formtype'		=> 'text' ,
											'valuetype'		=> 'int' ,
											'default'		=> 24 ,
											'options'		=> array()
				...
				"wortify_groups_denyipmove" => array(
											...
											'title'			=> '_WORTIFY_HIJACK_DENYGP' ,
											'description'	=> '_WORTIFY_HIJACK_DENYGPDSC' ,
				...
				"wortify_san_nullbyte" => array(
											...
											'title'			=> '_WORTIFY_SAN_NULLBYTE' ,
											'description'	=> '_WORTIFY_SAN_NULLBYTEDSC' ,
											'formtype'		=> 'yesno' ,
											'valuetype'		=> 'int' ,
											'default'		=> "1" ,
											'options'		=> array()
				...
				"wortify_die_badext" => array(
												...
												'title'			=> '_WORTIFY_DIE_BADEXT' ,
												'description'	=> '_WORTIFY_DIE_BADEXTDSC' ,
												'formtype'		=> 'yesno' ,
												'valuetype'		=> 'int' ,
												'default'		=> "1" ,
												'options'		=> array()
				...
				"wortify_contami_action" => array(
											...
											'title'			=> '_WORTIFY_CONTAMI_ACTION' ,
											'description'	=> '_WORTIFY_CONTAMI_ACTIONDS' ,
											'formtype'		=> 'select' ,
											'valuetype'		=> 'int' ,
											'default'		=> 3 ,
											'options'		=> array( '_WORTIFY_OPT_NONE' => 0 , '_WORTIFY_OPT_EXIT' => 3 , '_WORTIFY_OPT_BIPTIME0' => 7 , '_WORTIFY_OPT_BIP' => 15 )
										),
				"wortify_isocom_action" => array(
												'name'			=> 'wortify_isocom_action' ,
												'title'			=> '_WORTIFY_ISOCOM_ACTION' ,
												'description'	=> '_WORTIFY_ISOCOM_ACTIONDSC' ,
												'formtype'		=> 'select' ,
												'valuetype'		=> 'int' ,
												'default'		=> 0 ,
												'options'		=> array( '_WORTIFY_OPT_NONE' => 0 , '_WORTIFY_OPT_SAN' => 1 , '_WORTIFY_OPT_EXIT' => 3 , '_WORTIFY_OPT_BIPTIME0' => 7 , '_WORTIFY_OPT_BIP' => 15 )
											),
				"wortify_id_forceintoption_value" => array(
												'name'			=> 'wortify_id_forceintoption_value' ,
												'title'			=> '_WORTIFY_ID_INTVAL' ,
												'description'	=> '_WORTIFY_ID_INTVALDSC' ,
												'formtype'		=> 'yesno' ,
												'valuetype'		=> 'int' ,
												'default'		=> "0" ,
												'options'		=> array()
				...
				"wortify_file_dotdot" => array(
											...
											'title'			=> '_WORTIFY_FILE_DOTDOT' ,
											'description'	=> '_WORTIFY_FILE_DOTDOTDSC' ,
											'formtype'		=> 'yesno' ,
											'valuetype'		=> 'int' ,
											'default'		=> "1" ,
											'options'		=> array()
				...
				"wortify_bf_count" => array(
											...
											'title'			=> '_WORTIFY_BF_COUNT' ,
											'description'	=> '_WORTIFY_BF_COUNTDSC' ,
											'formtype'		=> 'text' ,
											'valuetype'		=> 'int' ,
											'default'		=> "10" ,
											'options'		=> array()
				...
				"wortify_bwlimit_count" => array(
											...
											'title'			=> '_WORTIFY_BWLIMIT_COUNT' ,
											'description'	=> '_WORTIFY_BWLIMIT_COUNTDSC' ,
											'formtype'		=> 'text' ,
											'valuetype'		=> 'int' ,
											'default'		=> 0 ,
											'options'		=> array()
				...
				"wortify_dos_skipmodules" => array(
												...
												'title'			=> '_WORTIFY_DOS_SKIPMODS' ,
												'description'	=> '_WORTIFY_DOS_SKIPMODSDSC' ,
												'formtype'		=> 'text' ,
												'valuetype'		=> 'text' ,
												'default'		=> "" ,
												'options'		=> array()
				...
				"wortify_dos_expire" => array(
												...
												'title'			=> '_WORTIFY_DOS_EXPIRE' ,
												'description'	=> '_WORTIFY_DOS_EXPIREDSC' ,
												'formtype'		=> 'text' ,
												'valuetype'		=> 'int' ,
												'default'		=> "60" ,
												'options'		=> array()
				...
				"wortify_dos_f5count" => array(
													...
													'title'			=> '_WORTIFY_DOS_F5COUNT' ,
													'description'	=> '_WORTIFY_DOS_F5COUNTDSC' ,
													'formtype'		=> 'text' ,
													'valuetype'		=> 'int' ,
													'default'		=> "20" ,
													'options'		=> array()
				...
				"wortify_dos_f5action" => array(
												...
												'title'			=> '_WORTIFY_DOS_F5ACTION' ,
												'description'	=> '' ,
												'formtype'		=> 'select' ,
												'valuetype'		=> 'text' ,
												'default'		=> "exit" ,
												'options'		=> array( '_WORTIFY_DOSOPT_NONE' => 'none' , '_WORTIFY_DOSOPT_SLEEP' => 'sleep' , '_WORTIFY_DOSOPT_EXIT' => 'exit' , '_WORTIFY_DOSOPT_BIPTIME0' => 'biptime0' , '_WORTIFY_DOSOPT_BIP' => 'bip' , '_WORTIFY_DOSOPT_HTA' => 'hta' )
											) ,
				"wortify_dos_crcount" =>  array(
												'name'			=> 'wortify_dos_crcount' ,
												'title'			=> '_WORTIFY_DOS_CRCOUNT' ,
												'description'	=> '_WORTIFY_DOS_CRCOUNTDSC' ,
												'formtype'		=> 'text' ,
												'valuetype'		=> 'int' ,
												'default'		=> "40" ,
												'options'		=> array()
				...
				"wortify_dos_crsafe" => array(
												...
												'title'			=> '_WORTIFY_DOS_CRSAFE' ,
												'description'	=> '_WORTIFY_DOS_CRSAFEDSC' ,
												'formtype'		=> 'text' ,
												'valuetype'		=> 'text' ,
				...
				"wortify_bip_except" => array(
												...
												'title'			=> '_WORTIFY_BIP_EXCEPT' ,
												'description'	=> '_WORTIFY_BIP_EXCEPTDSC' ,
												'formtype'		=> 'group_multi' ,
												'valuetype'		=> 'array' ,
												'default'		=> array(1) ,
												'options'		=> array()
				...
				"wortify_enable_bigumbrella" => array(
												...
												'title'			=> '_WORTIFY_BIGUMBRELLA' ,
												'description'	=> '_WORTIFY_BIGUMBRELLADSC' ,
												'formtype'		=> 'yesno' ,
												'valuetype'		=> 'int' ,
												'default'		=> 1 ,
												'options'		=> array()
				...
				"wortify_spamcount_uri4user" => array(
											...
											'title'			=> '_WORTIFY_SPAMURI4U' ,
											'description'	=> '_WORTIFY_SPAMURI4UDSC' ,
											'formtype'		=> 'textbox' ,
											'valuetype'		=> 'int' ,
											'default'		=> 0 ,
											'options'		=> array()
				...
				"wortify_spamcount_uri4guest" => array(
											...
											'title'			=> '_WORTIFY_SPAMURI4G' ,
											'description'	=> '_WORTIFY_SPAMURI4GDSC' ,
											'formtype'		=> 'textbox' ,
											'valuetype'		=> 'int' ,
											'default'		=> 5 ,
											'options'		=> array()
				...
				"wortify_stopforumspam_action" =>  array(
											...
											'title'			=> '_WORTIFY_STOPFORUMSPAM_ACTION' ,
											'description'	=> '_WORTIFY_STOPFORUMSPAM_ACTIONDSC' ,
											'formtype'		=> 'select' ,
											'valuetype'		=> 'text' ,
											'default'		=> 'none' ,
											'options'		=> array( '_NONE' => 'none', '_WORTIFY_OPT_NONE' => 'log' , '_WORTIFY_OPT_SAN' => 'san' , '_WORTIFY_OPT_BIPTIME0' => 'biptime0' , '_WORTIFY_OPT_BIP' => 'bip')
										)
						),
			"xortify" => array(
				"xortify_protocol" => array('name' => 'xortify_protocol',
										'title' => '_WORTIFY_PROTOCOL',
										'description' => '_WORTIFY_PROTOCOL_DESC',
										'formtype' => 'select',
										'valuetype' => 'text',
										'default' => 'rest_curlserialised',
										'options' => array(_WORTIFY_PROTOCOL_MINIMUMCLOUD=>'minimisedcloud', _WORTIFY_PROTOCOL_WGETSERIAL=>'rest_wgetserialised', _WORTIFY_PROTOCOL_WGETXML=>'rest_wgetxml', _WORTIFY_PROTOCOL_CURLSERIAL=>'rest_curlserialised', _WORTIFY_PROTOCOL_CURL=>'rest_curl', _WORTIFY_PROTOCOL_JSON=>'rest_json', _WORTIFY_PROTOCOL_CURLXML=>'rest_curlxml'),
										),
					"xortify_useroption_name" => array('name' => 'xortify_username',
							'title' => '_WORTIFY_USERNAME',
							'description' => '_WORTIFY_USERNAME_DESC',
							'formtype' => 'text',
							'valuetype' => 'text',
							'default' => ''
					),
					"xortify_password" => array('name' => 'xortify_password',
							'title' => '_WORTIFY_PASSWORD',
							'description' => '_WORTIFY_PASSWORD_DESC',
							'formtype' => 'password',
							'valuetype' => 'text',
							'default' => '',
					),
					"xortify_seconds" => array('name' => 'xortify_seconds',
							'title' => '_WORTIFY_SECONDS',
							'description' => '_WORTIFY_SECONDS_DESC',
							'formtype' => 'select',
							'valuetype' => 'int',
							'default' => 3600,
							'options' => array(_WORTIFY_SECONDS_37600 => 37600, _WORTIFY_SECONDS_28800 => 28800, _WORTIFY_SECONDS_14400 => 14400, _WORTIFY_SECONDS_7200 => 7200,
									_WORTIFY_SECONDS_3600 => 3600, _WORTIFY_SECONDS_1800 => 1800, _WORTIFY_SECONDS_1200 => 1200, _WORTIFY_SECONDS_600 => 600,
									_WORTIFY_SECONDS_300 => 300, _WORTIFY_SECONDS_180 => 180, _WORTIFY_SECONDS_60 => 60, _WORTIFY_SECONDS_30 => 30)
					),
					"xortify_ip_cache" => array('name' => 'xortify_ip_cache',
							'title' => '_WORTIFY_IPCACHE',
							'description' => '_WORTIFY_IPCACHE_DESC',
							'formtype' => 'select',
							'valuetype' => 'int',
							'default' => 86400,
							'options' => array(_WORTIFY_SECONDS_29030400 => 29030400, _WORTIFY_SECONDS_14515200 => 14515200, _WORTIFY_SECONDS_7257600 => 7257600, _WORTIFY_SECONDS_2419200 => 2419200,
									_WORTIFY_SECONDS_1209600 => 1209600, _WORTIFY_SECONDS_604800 => 604800, _WORTIFY_SECONDS_86400 => 86400, _WORTIFY_SECONDS_43200 => 43200,
									_WORTIFY_SECONDS_37600 => 37600, _WORTIFY_SECONDS_28800 => 28800, _WORTIFY_SECONDS_14400 => 14400, _WORTIFY_SECONDS_7200 => 7200,
									_WORTIFY_SECONDS_3600 => 3600, _WORTIFY_SECONDS_1800 => 1800, _WORTIFY_SECONDS_1200 => 1200, _WORTIFY_SECONDS_600 => 600,
									_WORTIFY_SECONDS_300 => 300, _WORTIFY_SECONDS_180 => 180, _WORTIFY_SECONDS_60 => 60, _WORTIFY_SECONDS_30 => 30)
					),
					"xortify_server_cache" => array('name' => 'xortify_server_cache',
							'title' => '_WORTIFY_SERVERCACHE',
							'description' => '_WORTIFY_SERVERCACHE_DESC',
							'formtype' => 'select',
							'valuetype' => 'int',
							'default' => 604800,
							'options' => array(_WORTIFY_SECONDS_29030400 => 29030400, _WORTIFY_SECONDS_14515200 => 14515200, _WORTIFY_SECONDS_7257600 => 7257600, _WORTIFY_SECONDS_2419200 => 2419200,
					...
					"xortify_records" => array('name' => 'xortify_records',
							'title' => '_WORTIFY_RECORDS',
							'description' => '_WORTIFY_RECORDS_DESC',
							'formtype' => 'select',
							'valuetype' => 'int',
							'default' => 3600,
							'options' => array(_WORTIFY_RECORDS_177600 => 177600, _WORTIFY_RECORDS_48800 => 48800, _WORTIFY_RECORDS_24400 => 24400, _WORTIFY_RECORDS_12200 => 12200,
									_WORTIFY_RECORDS_3600 => 3600, _WORTIFY_RECORDS_1800 => 1800, _WORTIFY_RECORDS_1200 => 1200, _WORTIFY_RECORDS_600 => 600,
									_WORTIFY_RECORDS_300 => 300, _WORTIFY_RECORDS_180 => 180, _WORTIFY_RECORDS_60 => 60, _WORTIFY_RECORDS_30 => 30),
								
					),
					"xortify_providers" => array('name' => 'xortify_providers',
							'title' => '_WORTIFY_PROVIDERS',
							'description' => '_WORTIFY_PROVIDERS_DESC',
							'formtype' => 'select_multi',
							'valuetype' => 'array',
							'default' => array('xortify', 'protector', 'stopforumspam.com', 'projecthoneypot.org'),
							'options' => array('(none)' => '', _WORTIFY_PROVIDERWORTIFYTIFY => 'xortify', _WORTIFY_PROVIDER_PROTECTOR => 'protector', _WORTIFY_PROVIDER_STOPFORUMSPAM => 'stopforumspam.com', _WORTIFY_PROVIDER_PROJECTHONEYPOT => 'projecthoneypot.org')
					),					
				"xortify_urirest" => array('name' => 'xortify_urirest',
								'title' => '_WORTIFY_URIREST',
								'description' => '_WORTIFY_URIREST_DESC',
								'formtype' => 'text',
								'valuetype' => 'text',
								'default' => _WORTIFY_API_URL_WORTIFY,
								),
				"xortify_save_banned" => array('name' => 'xortify_save_banned',
									'title' => '_WORTIFY_LOG_BANNED',
									'description' => '_WORTIFY_LOG_BANNED_DESC',
									'formtype' => 'yesno',
									'valuetype' => 'int',
									'default' => true,
									),
				"xortify_save_blocked" => array('name' => 'xortify_save_blocked',
									'title' => '_WORTIFY_LOG_BLOCKED',
									'description' => '_WORTIFY_LOG_BLOCKED_DESC',
									'formtype' => 'yesno',
									'valuetype' => 'int',
									'default' => true,
									),
				"xortify_save_monitored" => array('name' => 'xortify_save_monitored',
								'title' => '_WORTIFY_LOG_MONITORED',
								'description' => '_WORTIFY_LOG_MONITORED_DESC',
								'formtype' => 'yesno',
								'valuetype' => 'int',
								'default' => true
								) ,
				"xortify_octeta" => array('name' => 'xortify_octeta',
							'title' => '_WORTIFY_PHP_NUMBEROFDAYS',
							'description' => '_WORTIFY_PHP_NUMBEROFDAYS_DESC',
							'formtype' => 'select',
							'valuetype' => 'int',
							'default' => 92,
				...
				"xortify_octetb" => array('name' => 'xortify_octetb',
									'title' => '_WORTIFY_PHP_SEVERITYLEVEL',
									'description' => '_WORTIFY_PHP_SEVERITYLEVEL_DESC',
									'formtype' => 'select',
									'valuetype' => 'int',
									'default' => 15,
				...
				"xortify_octetc" => array('name' => 'xortify_octetc',
										'title' => '_WORTIFY_PHP_SCANMODE',
										'description' => '_WORTIFY_PHP_SCANMODE_DESC',
										'formtype' => 'select',
										'valuetype' => 'int',
										'default' => 2,
										'options' => array(_WORTIFY_PHP_SCANMODE_SUSPICIOUS => 1, _WORTIFY_PHP_SCANMODE_HARVESTER => 2, _WORTIFY_PHP_SCANMODE_SUSICIOUSHARVESTER => 3, 
																					 _WORTIFY_PHP_SCANMODE_SPAMMER => 4, _WORTIFY_PHP_SCANMODE_SUSPICIOUSSPAMMER => 5, _WORTIFY_PHP_SCANMODE_HARVESTERSPAMMER => 6, 
																					 _WORTIFY_PHP_SCANMODE_SUSPICIOUSHARVESTERSPAMMER => 7)
										),
				"xortify_email_freq" => array('name' => 'xortify_email_freq',
									'title' => '_WORTIFY_SFS_EMAILFREQUENCY',
									'description' => '_WORTIFY_SFS_EMAILFREQUENCY_DESC',
									'formtype' => 'select',
									'valuetype' => 'int',
									'default' => 2,
				...
				"xortify_email_lastseen" => array('name' => 'xortify_email_lastseen',
									'title' => '_WORTIFY_SFS_EMAILLASTSEEN',
									'description' => '_WORTIFY_SFS_EMAILLASTSEEN_DESC',
									'formtype' => 'select',
									'valuetype' => 'int',
									'default' => 7257600,
									'options' => array(_WORTIFY_SFS_LASTSEEN_24HOURS => 86400, _WORTIFY_SFS_LASTSEEN_1WEEK => 604800, _WORTIFY_SFS_LASTSEEN_FORTNIGHT => 1209600, 
																				 _WORTIFY_SFS_LASTSEEN_1MONTH => 2419200, _WORTIFY_SFS_LASTSEEN_2MONTHS => 4838400, _WORTIFY_SFS_LASTSEEN_3MONTHS => 7257600, 
																				 _WORTIFY_SFS_LASTSEEN_4MONTHS => 9676800, _WORTIFY_SFS_LASTSEEN_5MONTHS => 12096000, _WORTIFY_SFS_LASTSEEN_6MONTHS => 14515200,
																				 _WORTIFY_SFS_LASTSEEN_12MONTHS => 29030400, _WORTIFY_SFS_LASTSEEN_24MONTHS => 58060800),
									),
				"xortify_uoption_name_freq" => array('name' => 'xortify_uoption_name_freq',
										'title' => '_WORTIFY_SFS_UNAMEFREQUENCY',
										'description' => '_WORTIFY_SFS_UNAMEFREQUENCY_DESC',
										'formtype' => 'select',
										'valuetype' => 'int',
										'default' => 2,
										'options' => array("Occured 1 time(s)" => 1, "Occured 2 time(s)" => 2, "Occured 3 time(s)" => 3, "Occured 4 time(s)" => 4, "Occured 5 time(s)" => 5, "Occured 6 time(s)" => 6, "Occured 7 time(s)" => 7, "Occured 8 time(s)" => 8, "Occured 9 time(s)" => 9, "Occured 10 time(s)" => 10, "Occured 11 time(s)" => 11, "Occured 12 time(s)" => 12, "Occured 13 time(s)" => 13, "Occured 14 time(s)" => 14, "Occured 15 time(s)" => 15, "Occured 16 time(s)" => 16, "Occured 17 time(s)" => 17, "Occured 18 time(s)" => 18, "Occured 19 time(s)" => 19, "Occured 20 time(s)" => 20, "Occured 21 time(s)" => 21, "Occured 22 time(s)" => 22, "Occured 23 time(s)" => 23, "Occured 24 time(s)" => 24, "Occured 25 time(s)" => 25, "Occured 26 time(s)" => 26, "Occured 27 time(s)" => 27, "Occured 28 time(s)" => 28, "Occured 29 time(s)" => 29, "Occured 30 time(s)" => 30, "Occured 31 time(s)" => 31, "Occured 32 time(s)" => 32, "Occured 33 time(s)" => 33, "Occured 34 time(s)" => 34, "Occured 35 time(s)" => 35, "Occured 36 time(s)" => 36, "Occured 37 time(s)" => 37, "Occured 38 time(s)" => 38, "Occured 39 time(s)" => 39, "Occured 40 time(s)" => 40, "Occured 41 time(s)" => 41, "Occured 42 time(s)" => 42, "Occured 43 time(s)" => 43, "Occured 44 time(s)" => 44, "Occured 45 time(s)" => 45, "Occured 46 time(s)" => 46, "Occured 47 time(s)" => 47, "Occured 48 time(s)" => 48, "Occured 49 time(s)" => 49, "Occured 50 time(s)" => 50, "Occured 51 time(s)" => 51, "Occured 52 time(s)" => 52, "Occured 53 time(s)" => 53, "Occured 54 time(s)" => 54, "Occured 55 time(s)" => 55, "Occured 56 time(s)" => 56, "Occured 57 time(s)" => 57, "Occured 58 time(s)" => 58, "Occured 59 time(s)" => 59, "Occured 60 time(s)" => 60, "Occured 61 time(s)" => 61, "Occured 62 time(s)" => 62, "Occured 63 time(s)" => 63, "Occured 64 time(s)" => 64, "Occured 65 time(s)" => 65, "Occured 66 time(s)" => 66, "Occured 67 time(s)" => 67, "Occured 68 time(s)" => 68, "Occured 69 time(s)" => 69, "Occured 70 time(s)" => 70, "Occured 71 time(s)" => 71, "Occured 72 time(s)" => 72, "Occured 73 time(s)" => 73, "Occured 74 time(s)" => 74, "Occured 75 time(s)" => 75, "Occured 76 time(s)" => 76, "Occured 77 time(s)" => 77, "Occured 78 time(s)" => 78, "Occured 79 time(s)" => 79, "Occured 80 time(s)" => 80, "Occured 81 time(s)" => 81, "Occured 82 time(s)" => 82, "Occured 83 time(s)" => 83, "Occured 84 time(s)" => 84, "Occured 85 time(s)" => 85, "Occured 86 time(s)" => 86, "Occured 87 time(s)" => 87, "Occured 88 time(s)" => 88, "Occured 89 time(s)" => 89, "Occured 90 time(s)" => 90, "Occured 91 time(s)" => 91, "Occured 92 time(s)" => 92, "Occured 93 time(s)" => 93, "Occured 94 time(s)" => 94, "Occured 95 time(s)" => 95, "Occured 96 time(s)" => 96, "Occured 97 time(s)" => 97, "Occured 98 time(s)" => 98, "Occured 99 time(s)" => 99, "Occured 100 time(s)" => 100, "Occured 101 time(s)" => 101, "Occured 102 time(s)" => 102, "Occured 103 time(s)" => 103, "Occured 104 time(s)" => 104, "Occured 105 time(s)" => 105, "Occured 106 time(s)" => 106, "Occured 107 time(s)" => 107, "Occured 108 time(s)" => 108, "Occured 109 time(s)" => 109, "Occured 110 time(s)" => 110, "Occured 111 time(s)" => 111, "Occured 112 time(s)" => 112, "Occured 113 time(s)" => 113, "Occured 114 time(s)" => 114, "Occured 115 time(s)" => 115, "Occured 116 time(s)" => 116, "Occured 117 time(s)" => 117, "Occured 118 time(s)" => 118, "Occured 119 time(s)" => 119, "Occured 120 time(s)" => 120, "Occured 121 time(s)" => 121, "Occured 122 time(s)" => 122, "Occured 123 time(s)" => 123, "Occured 124 time(s)" => 124, "Occured 125 time(s)" => 125, "Occured 126 time(s)" => 126, "Occured 127 time(s)" => 127, "Occured 128 time(s)" => 128, "Occured 129 time(s)" => 129, "Occured 130 time(s)" => 130, "Occured 131 time(s)" => 131, "Occured 132 time(s)" => 132, "Occured 133 time(s)" => 133, "Occured 134 time(s)" => 134, "Occured 135 time(s)" => 135, "Occured 136 time(s)" => 136, "Occured 137 time(s)" => 137, "Occured 138 time(s)" => 138, "Occured 139 time(s)" => 139, "Occured 140 time(s)" => 140, "Occured 141 time(s)" => 141, "Occured 142 time(s)" => 142, "Occured 143 time(s)" => 143, "Occured 144 time(s)" => 144, "Occured 145 time(s)" => 145, "Occured 146 time(s)" => 146, "Occured 147 time(s)" => 147, "Occured 148 time(s)" => 148, "Occured 149 time(s)" => 149, "Occured 150 time(s)" => 150),
				...
				"xortify_uoption_name_lastseen" =>  array('name' => 'xortify_uoption_name_lastseen',
										'title' => '_WORTIFY_SFS_UNAMELASTSEEN',
										'description' => '_WORTIFY_SFS_UNAMELASTSEEN_DESC',
										'formtype' => 'select',
										'valuetype' => 'int',
										'default' => 7257600,
										'options' => array(_WORTIFY_SFS_LASTSEEN_24HOURS => 86400, _WORTIFY_SFS_LASTSEEN_1WEEK => 604800, _WORTIFY_SFS_LASTSEEN_FORTNIGHT => 1209600, 
				...
				"xortify_ip_freq" => array('name' => 'xortify_ip_freq',
										'title' => '_WORTIFY_SFS_IPFREQUENCY',
										'description' => '_WORTIFY_SFS_IPFREQUENCY_DESC',
										'formtype' => 'select',
										'valuetype' => 'int',
										'default' => 2,
										'options' => array("Occured 1 time(s)" => 1, "Occured 2 time(s)" => 2, "Occured 3 time(s)" => 3, "Occured 4 time(s)" => 4, "Occured 5 time(s)" => 5, "Occured 6 time(s)" => 6, "Occured 7 time(s)" => 7, "Occured 8 time(s)" => 8, "Occured 9 time(s)" => 9, "Occured 10 time(s)" => 10, "Occured 11 time(s)" => 11, "Occured 12 time(s)" => 12, "Occured 13 time(s)" => 13, "Occured 14 time(s)" => 14, "Occured 15 time(s)" => 15, "Occured 16 time(s)" => 16, "Occured 17 time(s)" => 17, "Occured 18 time(s)" => 18, "Occured 19 time(s)" => 19, "Occured 20 time(s)" => 20, "Occured 21 time(s)" => 21, "Occured 22 time(s)" => 22, "Occured 23 time(s)" => 23, "Occured 24 time(s)" => 24, "Occured 25 time(s)" => 25, "Occured 26 time(s)" => 26, "Occured 27 time(s)" => 27, "Occured 28 time(s)" => 28, "Occured 29 time(s)" => 29, "Occured 30 time(s)" => 30, "Occured 31 time(s)" => 31, "Occured 32 time(s)" => 32, "Occured 33 time(s)" => 33, "Occured 34 time(s)" => 34, "Occured 35 time(s)" => 35, "Occured 36 time(s)" => 36, "Occured 37 time(s)" => 37, "Occured 38 time(s)" => 38, "Occured 39 time(s)" => 39, "Occured 40 time(s)" => 40, "Occured 41 time(s)" => 41, "Occured 42 time(s)" => 42, "Occured 43 time(s)" => 43, "Occured 44 time(s)" => 44, "Occured 45 time(s)" => 45, "Occured 46 time(s)" => 46, "Occured 47 time(s)" => 47, "Occured 48 time(s)" => 48, "Occured 49 time(s)" => 49, "Occured 50 time(s)" => 50, "Occured 51 time(s)" => 51, "Occured 52 time(s)" => 52, "Occured 53 time(s)" => 53, "Occured 54 time(s)" => 54, "Occured 55 time(s)" => 55, "Occured 56 time(s)" => 56, "Occured 57 time(s)" => 57, "Occured 58 time(s)" => 58, "Occured 59 time(s)" => 59, "Occured 60 time(s)" => 60, "Occured 61 time(s)" => 61, "Occured 62 time(s)" => 62, "Occured 63 time(s)" => 63, "Occured 64 time(s)" => 64, "Occured 65 time(s)" => 65, "Occured 66 time(s)" => 66, "Occured 67 time(s)" => 67, "Occured 68 time(s)" => 68, "Occured 69 time(s)" => 69, "Occured 70 time(s)" => 70, "Occured 71 time(s)" => 71, "Occured 72 time(s)" => 72, "Occured 73 time(s)" => 73, "Occured 74 time(s)" => 74, "Occured 75 time(s)" => 75, "Occured 76 time(s)" => 76, "Occured 77 time(s)" => 77, "Occured 78 time(s)" => 78, "Occured 79 time(s)" => 79, "Occured 80 time(s)" => 80, "Occured 81 time(s)" => 81, "Occured 82 time(s)" => 82, "Occured 83 time(s)" => 83, "Occured 84 time(s)" => 84, "Occured 85 time(s)" => 85, "Occured 86 time(s)" => 86, "Occured 87 time(s)" => 87, "Occured 88 time(s)" => 88, "Occured 89 time(s)" => 89, "Occured 90 time(s)" => 90, "Occured 91 time(s)" => 91, "Occured 92 time(s)" => 92, "Occured 93 time(s)" => 93, "Occured 94 time(s)" => 94, "Occured 95 time(s)" => 95, "Occured 96 time(s)" => 96, "Occured 97 time(s)" => 97, "Occured 98 time(s)" => 98, "Occured 99 time(s)" => 99, "Occured 100 time(s)" => 100, "Occured 101 time(s)" => 101, "Occured 102 time(s)" => 102, "Occured 103 time(s)" => 103, "Occured 104 time(s)" => 104, "Occured 105 time(s)" => 105, "Occured 106 time(s)" => 106, "Occured 107 time(s)" => 107, "Occured 108 time(s)" => 108, "Occured 109 time(s)" => 109, "Occured 110 time(s)" => 110, "Occured 111 time(s)" => 111, "Occured 112 time(s)" => 112, "Occured 113 time(s)" => 113, "Occured 114 time(s)" => 114, "Occured 115 time(s)" => 115, "Occured 116 time(s)" => 116, "Occured 117 time(s)" => 117, "Occured 118 time(s)" => 118, "Occured 119 time(s)" => 119, "Occured 120 time(s)" => 120, "Occured 121 time(s)" => 121, "Occured 122 time(s)" => 122, "Occured 123 time(s)" => 123, "Occured 124 time(s)" => 124, "Occured 125 time(s)" => 125, "Occured 126 time(s)" => 126, "Occured 127 time(s)" => 127, "Occured 128 time(s)" => 128, "Occured 129 time(s)" => 129, "Occured 130 time(s)" => 130, "Occured 131 time(s)" => 131, "Occured 132 time(s)" => 132, "Occured 133 time(s)" => 133, "Occured 134 time(s)" => 134, "Occured 135 time(s)" => 135, "Occured 136 time(s)" => 136, "Occured 137 time(s)" => 137, "Occured 138 time(s)" => 138, "Occured 139 time(s)" => 139, "Occured 140 time(s)" => 140, "Occured 141 time(s)" => 141, "Occured 142 time(s)" => 142, "Occured 143 time(s)" => 143, "Occured 144 time(s)" => 144, "Occured 145 time(s)" => 145, "Occured 146 time(s)" => 146, "Occured 147 time(s)" => 147, "Occured 148 time(s)" => 148, "Occured 149 time(s)" => 149, "Occured 150 time(s)" => 150),
				...
				"xortify_ip_lastseen" => array('name' => 'xortify_ip_lastseen',
									'title' => '_WORTIFY_SFS_IPLASTSEEN',
									'description' => '_WORTIFY_SFS_IPLASTSEEN_DESC',
									'formtype' => 'select',
									'valuetype' => 'int',
									'default' => 7257600,
									'options' => array(_WORTIFY_SFS_LASTSEEN_24HOURS => 86400, _WORTIFY_SFS_LASTSEEN_1WEEK => 604800, _WORTIFY_SFS_LASTSEEN_FORTNIGHT => 1209600, 
				...
				"xortify_logdrops" => array('name' => 'xortify_logdrops',
										'title' => '_WORTIFY_LOGDROPS',
										'description' => '_WORTIFY_LOGDROPS_DESC',
										'formtype' => 'select',
										'valuetype' => 'int',
										'default' => 2419200,
										'options' => array(_WORTIFY_SFS_LASTSEEN_24HOURS => 86400, _WORTIFY_SFS_LASTSEEN_1WEEK => 604800, _WORTIFY_SFS_LASTSEEN_FORTNIGHT => 1209600, 
				...
				"xortify_fault_delay" => array('name' => 'xortify_fault_delay',
											'title' => '_WORTIFY_FAULT_DELAY',
											'description' => '_WORTIFY_FAULT_DELAY_DESC',
											'formtype' => 'text',
											'valuetype' => 'int',
											'default' => 600
											),
				"xortify_curl_timeout" => array('name' => 'xortify_curl_timeout',
										'title' => '_WORTIFY_CURL_TIMOUT',
										'description' => '_WORTIFY_CURL_TIMOUT_DESC',
										'formtype' => 'text',
										'valuetype' => 'int',
										'default' => 40,
				...
				"xortify_curl_connecttimeout" =>  array('name' => 'xortify_curl_connecttimeout',
											'title' => '_WORTIFY_CURL_CONNECTTIMOUT',
											'description' => '_WORTIFY_CURL_CONNECTTIMOUT_DESC',
											'formtype' => 'text',
											'valuetype' => 'int',
											'default' => 20,
											),
				"xortify_users_to_check" => array('name' => 'xortify_users_to_check',
										'title' => '_WORTIFY_USERSTOCHECK',
										'description' => '_WORTIFY_USERSTOCHECK_DESC',
										'formtype' => 'select',
										'valuetype' => 'int',
										'default' => 180,
										'options' => array(_WORTIFY_RECORDS_177600 => 177600, _WORTIFY_RECORDS_48800 => 48800, _WORTIFY_RECORDS_24400 => 24400, _WORTIFY_RECORDS_12200 => 12200,
												_WORTIFY_RECORDS_3600 => 3600, _WORTIFY_RECORDS_1800 => 1800, _WORTIFY_RECORDS_1200 => 1200, _WORTIFY_RECORDS_600 => 600,
												_WORTIFY_RECORDS_300 => 300, _WORTIFY_RECORDS_180 => 180, _WORTIFY_RECORDS_60 => 60, _WORTIFY_RECORDS_30 => 30, _WORTIFY_DISABLED => 0),
										),
				"xortify_allowed_spams" => array('name' => 'xortify_allowed_spams',
											'title' => '_WORTIFY_ALLOWEDSPAMS',
											'description' => '_WORTIFY_ALLOWEDSPAMS_DESC',
											'formtype' => 'text',
											'valuetype' => 'int',
											'default' => 10,
											),
				"xortify_check_spams" => array('name' => 'xortify_check_spams',
										'title' => '_WORTIFY_CHECKSPAMS',
										'description' => '_WORTIFY_CHECKSPAMS_DESC',
										'formtype' => 'group_multi',
										'valuetype' => 'array',
										'default' => array(),
										),
				"xortify_min_words" =>  array('name' => 'xortify_min_words',
											'title' => '_WORTIFY_MINIMUMWORDS',
											'description' => '_WORTIFY_MINIMUMWORDS_DESC',
											'formtype' => 'text',
											'valuetype' => 'int',
											'default' => 40,
											),
				"xortify_min_words_groups" =>  array('name' => 'xortify_min_words_groups',
											'title' => '_WORTIFY_MINIMUMWORDSGROUPS',
											'description' => '_WORTIFY_MINIMUMWORDSGROUPS_DESC',
											'formtype' => 'group_multi',
											'valuetype' => 'array',
											'default' => array(),
											)
			...
			"ipinfodb" => array(
				"ipinfodb_api_url" => array('name' => 'ipinfodb_api_url',
						'title' => '_WORTIFY_IPINFODB_URL',
						'description' => '_WORTIFY_IPINFODB_URL_DESC',
						'formtype' => 'text',
						'valuetype' => 'text',
						'default' => ''
				),
				"ipinfodb_api_key" => array('name' => 'ipinfodb_api_key',
						'title' => '_WORTIFY_IPINFODB_KEY',
						'description' => '_WORTIFY_IPINFODB_KEY_DESC',
						'formtype' => 'text',
						'valuetype' => 'text',
						'default' => ''
				),
			...
			"alerts" => array(
				"alertEmails" => array('name' => 'alertEmails',
						'title' => '_WORTIFY_ALERT_EMAILS',
						'description' => '_WORTIFY_ALERT_EMAILS_DESC',
						'formtype' => 'textarea',
						'valuetype' => 'text',
						'default' => ''
				),
				"alertOn_warnings" => array('name' => 'alertOn_warnings',
						'title' => '_WORTIFY_ALERT_ON_WARNINGS',
						'description' => '_WORTIFY_ALERT_ON_WARNINGS_DESC',
						'formtype' => 'yesno',
						'valuetype' => 'integer',
						'default' => true
				),
				"alertOn_critical" => array('name' => 'alertOn_critical',
						'title' => '_WORTIFY_ALERT_ON_CRITICAL',
						'description' => '_WORTIFY_ALERT_ON_CRITICAL_DESC',
						'formtype' => 'yesno',
						'valuetype' => 'integer',
						'default' => true
				)
	...
	public static function setDefaults(){
		...
		if(self::get('maxMem', false) === false ){
			self::set('maxMem', _WORTIFY_MAX_MEMORY);
		}
	}
	...
	private static function getPotentialTempDirs() {
		return array(_WORTIFY_ROOT_PATH . '/wp-content/cache/xortify/', sys_get_temp_dir(), ABSPATH . 'wp-content/uploads/');
	}
