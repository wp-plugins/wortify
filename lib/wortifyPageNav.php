 ...
 *
 * @copyright   The WORTIFY Project http://sourceforge.net/projects/xoops/
...
class WortifyPageNav
{
     ...
     */
    function WortifyPageNav($total_items, $items_perpage, $current_start, $start_name = "start", $extra_arg = "")
    {
