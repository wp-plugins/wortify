 ...
 * @author          Skalpa Keo <skalpa@wortify.org>
...
class WortifyFormCheckBox extends WortifyFormElement
{
     ...
     */
    function WortifyFormCheckBox($caption, $name, $value = null, $delimeter = '&nbsp;')
    {
     ...
     *
     * @seealso WortifyForm::renderValidationJS
     */
