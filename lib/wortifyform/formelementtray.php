 ...
 */
class WortifyFormElementTray extends WortifyFormElement {
	/**
	 ...
	 */
	function WortifyFormElementTray( $caption, $delimeter = "&nbsp;", $name = "" ) {
		$this->setName( $name );
	 ...
	 * @return array Array of {@link WortifyFormElement} objects.
	 */
