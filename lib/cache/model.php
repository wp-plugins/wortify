 ...
 * @lastmodified $Date: 2011-11-06 16:09:33 +1100 (Sun, 06 Nov 2011) $
 ...
 * @subpackage cake.cake.libs.cache
 */
class WortifyCacheModel extends WortifyCacheEngine
{
    /**
     * settings
    ...
    function init($settings)
    {
        ...
        $this->model = new WortifyCacheModelHandler($wortifyDB);
        return true;
    }
    ...
    function read($key)
    {
        $criteria = new CriteriaCompo(new Criteria('key', $key));
 ...
 * @access public
 */
class WortifyCacheModelObject extends WortifyObject
{
    function WortifyCacheModelObject()
    {
        $this->__construct();
    }
 ...
 * @access public
 */
class WortifyCacheModelHandler extends WortifyPersistableObjectHandler
{
    const TABLE = 'cache_model';
    const CLASSNAME = 'WortifyCacheModelObject';
    const KEYNAME = 'key';
}
