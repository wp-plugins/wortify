...
class WortifyAuthRest_CurlserialisedProvisionning {
	...
	function &getInstance(&$auth_instance)
	{
		...
		if (!isset($provis_instance)) {
			$provis_instance = new WortifyAuthRest_CurlserialisedProvisionning($auth_instance);
		}
	 ...
	 */
	function WortifyAuthRest_CurlserialisedProvisionning (&$auth_instance) {
