...
class WortifytsRtsp extends WortifyTextSanitizerExtension
{
    function encode($textarea_id)
    {
        $config = parent::loadConfig(dirname(__FILE__));
        $code = "<img src='{$this->image_path}/rtspimg.gif' alt='" . _WORTIFY_FORM_ALTRTSP . "' onclick='wortifyCodeRtsp(\"{$textarea_id}\",\"" . htmlspecialchars(_WORTIFY_FORM_ENTERRTSPURL, ENT_QUOTES) . "\",\"" . htmlspecialchars(_WORTIFY_FORM_ENTERHEIGHT, ENT_QUOTES) . "\",\"" . htmlspecialchars(_WORTIFY_FORM_ENTERWIDTH, ENT_QUOTES) . "\");'  onmouseover='style.cursor=\"hand\"'/>&nbsp;";
        $javascript = <<<EOH
            function wortifyCodeRtsp(id,enterRtspPhrase, enterRtspHeightPhrase, enterRtspWidthPhrase){
